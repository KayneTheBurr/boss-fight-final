...
public class WeaponManager : MonoBehaviour
{
    ...
    public void SetWeaponDamage(CharacterManager characterWithWeapon, WeaponItem weapon)
    {
        ...
        meleeDamageCollider.light_Attack_03_DamageModifier = weapon.light_Attack_03_DamageModifier;
        meleeDamageCollider.light_Attack_04_DamageModifier = weapon.light_Attack_04_DamageModifier;
        meleeDamageCollider.light_Attack_05_DamageModifier = weapon.light_Attack_05_DamageModifier;
        ...
        meleeDamageCollider.heavy_Attack_03_DamageModifier = weapon.heavy_Attack_03_DamageModifier;
        meleeDamageCollider.heavy_Attack_04_DamageModifier = weapon.heavy_Attack_04_DamageModifier;
        meleeDamageCollider.heavy_Attack_05_DamageModifier = weapon.heavy_Attack_05_DamageModifier;
